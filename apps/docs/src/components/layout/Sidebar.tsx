...
export const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      <aside className={`
        fixed inset-y-0 left-0 w-[240px] bg-surface border-r border-border flex flex-col z-40 overflow-y-auto scrollbar-thin
      ...
      `}>
        <div className="p-6 flex items-center justify-between">
          ...
          <button 
            onClick={onClose}
            className="md:hidden p-2 text-text-3 hover:text-text"
          >
