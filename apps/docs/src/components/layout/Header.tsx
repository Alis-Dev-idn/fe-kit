...
export const Header: React.FC<HeaderProps> = ({ onMenuClick }) => {
  ...
  return (
    <header className="h-[56px] sticky top-0 bg-bg/80 backdrop-blur-md border-b border-border px-4 md:px-8 flex items-center justify-between z-10">
      <div className="flex items-center gap-4">
        <button
          onClick={onMenuClick}
          className="md:hidden p-2 -ml-2 text-text-3 hover:text-text"
        >
